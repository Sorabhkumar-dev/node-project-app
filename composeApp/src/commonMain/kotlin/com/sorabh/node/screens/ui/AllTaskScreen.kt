...
fun AllTaskScreen(
    ...
    val viewModel = koinViewModel<AllTaskViewModel>()
    ...
    AllTaskContent(viewModel = viewModel,filterBottomSheet  = filterBottomSheet,onNavigate = onNavigate)
}

@OptIn(ExperimentalMaterial3Api::class)
@Composable
private fun AllTaskContent(viewModel: AllTaskViewModel,filterBottomSheet: SheetState, onNavigate: (NavKey) -> Unit) {
